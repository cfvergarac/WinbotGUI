...
#xpath=(//button[@class='btn-continuar'])[1]
...
Asignar elementos pagina vuelos
   [Arguments]      ${LENGUA}
    ...
    ${BtnCONTINUARALI}=     set variable if      ${LENGUA}=='ES'              xpath=//button[contains(.,'Continuar')]        xpath=//button[contains(.,'Continue')]
     set test variable     ${BtnCONTINUARALI}