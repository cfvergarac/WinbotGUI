...
${ChkTARJETACREDITO}      xpath=//div[@class='col-auto no-gutters'][1]      #xpath=//div[@class='accordeon-tab-content-title'][1]        #xpath=//div[@class='accordeon-tab-content-title'][contains(.,'Tarjeta de crédito')]     #xpath=//label[@for='payment_method_2']
