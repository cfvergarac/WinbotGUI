...
Manejo_flex
    ...
    #debug
    ${BundleDesplegado}=    Run Keyword And Ignore Error    Wait Until Element Is Visible     //label[@for='vuelo-ida-week-0basic']   3s    #(//div[@class='arrow-down arrow-bundle'])[1]     #(//img[@class='bundle-title-type ng-star-inserted'])[1]
    ${BundleDesplegado}=    Get From List     ${BundleDesplegado}    0

    Run Keyword If     ('${BundleDesplegado}' == 'FAIL')    Click Javascript    ${RDBVUELOIDA}
    CLick Element     (//img[@class='bundle-title-type ng-star-inserted'])[1]
...
BundlesRT
    #debug
    ${BundleDesplegado2}=    Run Keyword And Ignore Error     Wait Until Element Is Visible     (//img[contains(@class,'bundle-title-type ng-star-inserted')])[4]   1s      #(//div[@class='price-bundle ng-star-inserted'])[1]     #(//div[@class='price-bundle'])[1]
    ${BundleDesplegado2}=    Get From List     ${BundleDesplegado2}    0
...
Ingresa_adultos
    ...
    \    Wait Until Element Is Visible     ${TxtNOMBREADULTO}
...
Ingresa_infantes
    ...
    \    Select From List By Label          ${LblANOINF}      2020
